...
#include "Variant_TwinStick/AI/TwinStickNPCBomber.h"
...
ATwinStickNPCBomber::ATwinStickNPCBomber()
{
...
void ATwinStickNPCBomber::BeginPlay()
{
	Super::BeginPlay();
...
void ATwinStickNPCBomber::EndPlay(EEndPlayReason::Type EndPlayReason)
{
...
void ATwinStickNPCBomber::Destroyed()
{
...
void ATwinStickNPCBomber::NotifyHit(class UPrimitiveComponent* MyComp, AActor* Other, class UPrimitiveComponent* OtherComp, bool bSelfMoved, FVector HitLocation, FVector HitNormal, FVector NormalImpulse, const FHitResult& Hit)
{
...
void ATwinStickNPCBomber::ProjectileImpact(const FVector& ForwardVector)
{
	...
	// defer destruction
	GetWorld()->GetTimerManager().SetTimer(DestructionTimer, this, &ATwinStickNPCBomber::DeferredDestroy, DeferredDestructionTime, false);
}

void ATwinStickNPCBomber::DeferredDestroy()
{
	// destroy this actor
	Destroy();
}
